<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="名单编号" prop="mingdanbianhao">
            <el-input v-model="ruleForm.mingdanbianhao" 
                placeholder="名单编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.mingdanbianhao" label="名单编号" prop="mingdanbianhao">
              <el-input v-model="ruleForm.mingdanbianhao" 
                placeholder="名单编号" readonly></el-input>
          </el-form-item>
        </div>
                        ...
                        mingdanbianhao: this.getUUID(),
                        	        xuehao: '',
                                      ...
                                      xuehaoOptions: [],
                                                                                                                                                                rules: {
                  mingdanbianhao: [
                            { required: true, message: '名单编号不能为空', trigger: 'blur' },
                                    	                                                              ],
                  xuehao: [
                                    	                                                              ],
                  xueshengxingming: [
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          	            if(o=='mingdanbianhao'){
            this.ruleForm.mingdanbianhao = obj[o];
	    this.ro.mingdanbianhao = true;
            continue;
          }
	            	            if(o=='xuehao'){
