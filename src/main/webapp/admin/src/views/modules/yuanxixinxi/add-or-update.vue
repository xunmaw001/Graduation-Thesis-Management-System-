          ...
          <el-form-item class="input" label="院系名称" prop="yuanximingcheng">
              <el-input v-model="ruleForm.yuanximingcheng" 
                placeholder="院系名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="教学院长" prop="jiaoxueyuanzhang">
          <el-input v-model="ruleForm.jiaoxueyuanzhang" 
              placeholder="教学院长" clearable  :readonly="ro.jiaoxueyuanzhang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="教学院长" prop="jiaoxueyuanzhang">
              <el-input v-model="ruleForm.jiaoxueyuanzhang" 
                placeholder="教学院长" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="教学秘书" prop="jiaoxuemishu">
          <el-input v-model="ruleForm.jiaoxuemishu" 
              placeholder="教学秘书" clearable  :readonly="ro.jiaoxuemishu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="教学秘书" prop="jiaoxuemishu">
              <el-input v-model="ruleForm.jiaoxuemishu" 
                placeholder="教学秘书" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
  ...
  data() {
	...
	fuzeren : false,
            ...
            ruleForm: {
                  ...
                  jiaoxueyuanzhang: [
                            { required: true, message: '教学院长不能为空', trigger: 'blur' },
                                    	                                                              ],
                  jiaoxuemishu: [
                            { required: true, message: '教学秘书不能为空', trigger: 'blur' },
                                    	                                                              ],
                  fuzeren: [
                                    	                                                              ],
              }
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.yuanximingcheng = true;
            continue;
	            	            ...
	            	            if(o=='jiaoxueyuanzhang'){
            this.ruleForm.jiaoxueyuanzhang = obj[o];
	    this.ro.jiaoxueyuanzhang = true;
            continue;
          }
	            	            if(o=='jiaoxuemishu'){
            this.ruleForm.jiaoxuemishu = obj[o];
	    this.ro.jiaoxuemishu = true;
            continue;
          }
	            	            if(o=='fuzeren'){
