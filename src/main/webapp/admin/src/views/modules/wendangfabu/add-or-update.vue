  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.wendangbianhao" label="文档编号" prop="wendangbianhao">
              <el-input v-model="ruleForm.wendangbianhao" 
                placeholder="文档编号" readonly></el-input>
          </el-form-item>
        </div>
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `wendangfabu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.wendangfabuCrossAddOrUpdateFlag = false;
                  this.parent.search();
