...
export default {
  ...
  methods: {
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                        ...
                                        this.laiyuanOptions = "学生预订,教师建议,企业和社会征集,科研单位组织".split(',')
                                                                                                                                                                            },
                                                                                                        // 多级联动参数
                                                                                                                                    info(id) {
      this.$http({
        url: `shenqingketi/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `shenqingketi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.shenqingketiCrossAddOrUpdateFlag = false;
                  this.parent.search();
