<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="问题编号" prop="wentibianhao">
            <el-input v-model="ruleForm.wentibianhao" 
                placeholder="问题编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.wentibianhao" label="问题编号" prop="wentibianhao">
              <el-input v-model="ruleForm.wentibianhao" 
                placeholder="问题编号" readonly></el-input>
          </el-form-item>
        </div>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="问题名称" prop="wentimingcheng">
          <el-input v-model="ruleForm.wentimingcheng" 
              placeholder="问题名称" clearable  :readonly="ro.wentimingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="问题名称" prop="wentimingcheng">
              <el-input v-model="ruleForm.wentimingcheng" 
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          	            if(o=='wentibianhao'){
            this.ruleForm.wentibianhao = obj[o];
	    this.ro.wentibianhao = true;
            continue;
          }
	            	            if(o=='wentimingcheng'){
