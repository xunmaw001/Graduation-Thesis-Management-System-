<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="文档编号" prop="wendangbianhao">
          <el-input v-model="ruleForm.wendangbianhao" 
              placeholder="文档编号" clearable  :readonly="ro.wendangbianhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="文档编号" prop="wendangbianhao">
              <el-input v-model="ruleForm.wendangbianhao" 
                placeholder="文档编号" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="文档名称" prop="wendangmingcheng">
          <el-input v-model="ruleForm.wendangmingcheng" 
              placeholder="文档名称" clearable  :readonly="ro.wendangmingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="文档名称" prop="wendangmingcheng">
              <el-input v-model="ruleForm.wendangmingcheng" 
          ...
          <el-form-item class="input" label="类型" prop="leixing">
              <el-input v-model="ruleForm.leixing" 
                placeholder="类型" readonly></el-input>
                                    ...
                                    <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="学生文档" prop="xueshengwendang">
          <file-upload
          tip="点击上传学生文档"
          action="file/upload"
          :limit="1"
          :multiple="true"
          :fileUrls="ruleForm.xueshengwendang?ruleForm.xueshengwendang:''"
          @change="xueshengwendangUploadChange"
          ></file-upload>
        </el-form-item>  
        <div v-else>
          <el-form-item v-if="ruleForm.xueshengwendang" label="学生文档" prop="xueshengwendang">
            <el-button type="text" size="small" @click="download(ruleForm.xueshengwendang)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="打分" prop="dafen">
          <el-input v-model="ruleForm.dafen" 
              placeholder="打分" clearable  :readonly="ro.dafen"></el-input>
        </el-form-item>
        <div v-else>
...
export default {
  data() {
    ...
    return {
      ...
      type: '',
      ro:{
	wendangbianhao : false,
	wendangmingcheng : false,
	gonghao : false,
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          	            if(o=='wendangbianhao'){
            this.ruleForm.wendangbianhao = obj[o];
	    this.ro.wendangbianhao = true;
            continue;
          }
	            	            if(o=='wendangmingcheng'){
            this.ruleForm.wendangmingcheng = obj[o];
	    this.ro.wendangmingcheng = true;
            continue;
          }
	            	            if(o=='gonghao'){
	    ...
	    this.ro.leixing = true;
            continue;
	            	            ...
	            	            if(o=='xueshengwendang'){
            this.ruleForm.xueshengwendang = obj[o];
	    this.ro.xueshengwendang = true;
            continue;
          }
	            	            if(o=='dafen'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `dafenxinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.dafenxinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
    ...
    back() {
      ...
      this.parent.contentStyleChange();
                                                                                                                        ...
                                                                                                                        xueshengwendangUploadChange(fileUrls) {
                this.ruleForm.xueshengwendang = fileUrls;
				this.addEditUploadStyleChange()
            },
                                    	addEditStyleChange() {
	  this.$nextTick(()=>{
