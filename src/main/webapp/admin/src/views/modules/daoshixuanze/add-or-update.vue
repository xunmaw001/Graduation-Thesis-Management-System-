  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="导师姓名" prop="daoshixingming">
              <el-input v-model="ruleForm.daoshixingming" 
                placeholder="导师姓名" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="选择" prop="xuanze">
          <el-select v-model="ruleForm.xuanze" placeholder="请选择选择">
            <el-option
                v-for="(item,index) in xuanzeOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="选择" prop="xuanze">
	      <el-input v-model="ruleForm.xuanze"
                placeholder="选择" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
